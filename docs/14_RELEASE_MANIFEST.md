...
## v2.8.6 Ordered Next Steps

1. Codex G0 active docs review.
2. Antigravity G1 Controller Minimum State Machine.
3. Codex maintains and executes all Phase acceptance reports G0-G11.
4. After G1 is passed, Antigravity starts G2 Fake OpenCode Runtime.
